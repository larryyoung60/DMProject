...
using DMProject.Areas.HelpPage;
...
namespace DMProject.Controllers
{
    ...
    /// </summary>
    [System.Web.Mvc.RoutePrefix("api/postman")]
    public class PostmanController : ApiController
    {
        ...
        [System.Web.Mvc.Route(Name = "GetPostmanCollection")]
        ...
        private PostmanCollectionGet PostmanCollectionForController()
        {
            ...
            foreach (var apiDescriptionsByControllerGroup in apiDescriptionsByController)
            {
                ...
                foreach (var apiDescription in apiDescriptionsByControllerGroup
                    ...
                    .ThenBy(description => description.Documentation == null ? "" : description.Documentation.ToString(CultureInfo.InvariantCulture)))
                {
